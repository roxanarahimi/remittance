...
//        InvoiceProduct::query()->truncate();
        ...
        pluck('ProductNumber');
        $products = Product::where('Name', 'like', '%نودالیت%')->where('Name', 'not like', '%لیوانی%')->whereNotIn('Number', $productnumbers)->get();
        ...
        pluck('ProductNumber');
        $parts = Part::where('Name', 'like', '%نودالیت%')->where('Name', 'not like', '%لیوانی%')->whereNotIn('Code', $Codes)->get();
    ...
    {
        $partIDs = Part::where('Name', 'like', '%نودالیت%')->where('Name', 'not like', '%لیوانی%')->pluck("PartID");
