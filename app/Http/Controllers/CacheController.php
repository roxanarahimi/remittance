...
class CacheController extends Controller
{
    ...
    {
        $inventoryVoucherIDs = Invoice::all()->where('LGS3.InventoryVoucher.Date', '>=', today()->subDays(2))->orderByDesc('id')->pluck('OrderID');
        $orderIDs = Invoice::all()->where('LGS3.InventoryVoucher.Date', '>=', today()->subDays(2))->orderByDesc('id')->pluck('OrderID');
