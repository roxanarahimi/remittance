...
class TourInvoiceResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            "PartyMobile"=> $this->Tour->TourAssignmentItem->Assignmen->Transporter->Party->Mobile,
            "PartyFullName"=> $this->Tour->TourAssignmentItem->Assignmen->Transporter->Party->FullName,
