...
//        InvoiceProduct::query()->truncate();
        ...
        pluck('ProductNumber');
        $products = Product::where('Name', 'not like', '%لیوانی%')->where('Name', 'like', '%نودالیت%')->whereNotIn('Number', $productnumbers)->get();
        ...
        pluck('ProductNumber');
        $parts = Part::where('Name', 'not like', '%لیوانی%')->where('Name', 'like', '%نودالیت%')->whereNotIn('Code', $Codes)->get();
    ...
    {
        $partIDs = Part::where('Name', 'not like', '%لیوانی%')->where('Name', 'like', '%نودالیت%')->pluck("PartID");
