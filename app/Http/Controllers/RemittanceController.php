...
//            return response()->json($d3, 200);
    ...
    {
//        $party = Party::orderByDESC('PartyID')->where('Mobile',$request['mobile'])->with('Transporter')->first();
//        return [$party];

        $t = Transporter::orderByDESC('TransporterID')->where('PartyRef',"259224")->with('Party')->get();
        return [$t];
